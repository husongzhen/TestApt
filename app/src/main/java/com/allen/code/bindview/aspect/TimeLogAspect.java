package com.allen.code.bindview.aspect;

import com.allen.code.bindview.LogUtils;
...
public class TimeLogAspect {
    @Pointcut("execution(@com.example.TimeLog * *(..))")//方法切入点
    public void methodAnnotated() {
    }

    @Pointcut("execution(@com.example.TimeLog *.new(..))")//构造器切入点
